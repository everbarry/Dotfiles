...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- Screenshot
    , ((modm .|. shiftMask,       xK_s), spawn "~/bin/maimcopy")
...
--tallAccordion  = renamed [Replace "allAccordion"]
--           $ Accordion
...
myStartupHook = do
  ...
  spawnOnce "dunst"
  spawnOnce "xrandr --output HDMI-0 --primary --mode 1920x1080 --pos 0x0 --rotate normal --output DP-0 --off --output DP-1 --off --output eDP-1-1 --mode 1920x1080 --pos 1920x0 --rotate normal"
  spawnOnce "exec /usr/bin/lxpolkit" 
